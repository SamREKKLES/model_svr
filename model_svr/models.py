...
class DownConv_Res(Module):
    def __init__(self, in_feat, out_feat, drop_rate=0.4, bn_momentum=0.1, downsample=None):
        super(DownConv_Res, self).__init__()
        self.conv1 = nn.Conv2d(in_feat, out_feat, kernel_size=3, padding=1)
        self.conv1_bn = nn.BatchNorm2d(out_feat, momentum=bn_momentum)
        self.conv1_drop = nn.Dropout2d(drop_rate)
...
class UpConv(Module):
    def __init__(self, in_feat, out_feat, drop_rate=0.4, bn_momentum=0.1):
        ...
        # self.up1 = nn.ConvTranspose2d(in_feat-out_feat, in_feat-out_feat, 2, 2)
...
class Unet_Res(Module):
    ...
    def __init__(self, drop_rate=0.4, bn_momentum=0.1):
        ...
        # Bottom
        self.conv4 = DownConv_Res(256, 256, drop_rate, bn_momentum)
...
class Unet_Non_local_standard(Module):
    """A reference U-Net model.
